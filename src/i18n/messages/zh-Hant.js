...
export default {
  ...
  'tutorial.draw': '拖曳畫出一條環線，形狀和大小隨你。',
  'tutorial.erase': '點一下格子就能擦掉。',
  'tutorial.numbers': '數字周圍格子裡的轉彎會讓它減少，離得遠的轉彎不算。',
  'tutorial.zero': '把環線閉合還不夠，每個數字都要歸零。',
  'tutorial.win': '全部歸零，這道題就算解開了。',
  'tutorial.next': '下一步',
  'tutorial.gotIt': '知道了',
