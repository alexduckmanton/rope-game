...
export default {
  'meta.title': 'Loopy — 無料で遊べる毎日のループ論理パズル',
  'meta.description':
    '数字をすべて満たす閉じたループを一筆で描こう。毎日新しい論理パズルが3つの難易度で登場。無料、登録不要、ブラウザですぐ遊べます。',
  'meta.ogDescription':
    '数字をすべて満たす閉じたループを一筆で描こう。毎日新しい論理パズルが3つの難易度で登場。無料、登録不要。',
  'meta.imageAlt': 'Loopy – 無料で遊べる毎日のループ論理パズル',
  'meta.playTitle': '{difficulty} Loopy — 今日のループ論理パズル',
